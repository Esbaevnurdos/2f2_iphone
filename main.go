...
var iPhones = []iPhone{
	...
	{14, "Apple iPhone 11", "128 GB White (MQ233)", "$150"},
	{15, "Apple iPhone 11", "128 GB White (MQ233)", "$550"},
	{16, "Apple iPhone 14 Pro", "1TB Gold (MQ2V3)", "$1499"},
	{17, "Apple iPhone 14 Pro", "512GB Gold (MQ2V3)", "$1399"},
	{18, "Apple iPhone 14 Pro", "128GB Deep Purple (MQ0G3)", "$1600"},
	{19, "Apple iPhone 13 mini", "128GB Pink (MLK23)", "$850"},
	{20, "Apple iPhone 14 Pro", "256GB Space Black (MQ0T3)", "$3499"},
	{21, "Apple iPhone 14 Pro", "256GB Silver (MQ103)", "$1399"},
}
